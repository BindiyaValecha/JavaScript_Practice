...
console.log("multiplication", num3 * num4);
...
let num9 = 44;
if(num8 > num9){
    console.log("Larger number", num8 )
}
else if(num9 > num8){
    console.log("Large number",num9)
}
else if (num8 == num9){
...
let userName = "Bindiya Valecha";
let password = "12345";
if(userName == "Bindiya Valecha" && password == "12345"){
    console.log("Longing successful")
}
else{
